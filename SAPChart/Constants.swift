...
struct Constants {
    ...
    static let darkColor = UIColor(red: 210/255.0, green: 110/255.0, blue: 43/255.0, alpha: 1.0)
    static let lightColor = UIColor(red: 241/255.0, green: 167/255.0, blue: 138/255.0, alpha: 1.0)
